...
from rocket.msacluster_utils import load_fasta, encode_seqs, write_fasta, consensusVoting, lprint, plot_landscape
...
def main():
    ...
    p.add_argument("-i", action='store', help='fasta/a3m file of original alignment, or path containing fasta/a3m files')
